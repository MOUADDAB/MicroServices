...
import org.sid.secservice.sec.service.UserDetailsServisceImpl;
...
private UserDetailsServisceImpl userDetailsService;

    public SecurityConfig(UserDetailsServisceImpl userDetailsServisce) {
        this.userDetailsService = userDetailsServisce;
    }
